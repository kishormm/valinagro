    ...
    return (
        <main className="flex justify-center items-center min-h-screen font-sans">
            <div className="p-10 bg-white/80 backdrop-blur-sm rounded-xl shadow-2xl w-full max-w-md border border-gray-200/50">
                <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Member Portal Login</h1>
                ...
                <form onSubmit={handleUserLogin}>
                    ...
                    <div className="relative mb-4">
                        <input
                            ...
                            className="w-full p-3 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500"
                            required
                        />
                    </div>
                ...
                <div className="text-center mt-6">
                    <a href="/login/admin" className="text-sm text-green-700 hover:underline">Are you an administrator? Login here.</a>
                </div>
            </div>
        </main>
    );
